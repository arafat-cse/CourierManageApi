...
public partial class CourierApiContext : DbContext
{
    public CourierApiContext()
    {
    }

    public CourierApiContext(DbContextOptions<CourierApiContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-IRCUGIO;Initial Catalog=CourierApi;User id=sa;Password=12345; TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Parcel>(entity =>
        {
            ...
            entity.Property(e => e.IsDispatchedFromBranch).HasColumnName("isDispatchedFromBranch");
            entity.Property(e => e.IsInTransit).HasColumnName("isInTransit");
            entity.Property(e => e.IsReceivedAtBranch).HasColumnName("isReceivedAtBranch");
            entity.Property(e => e.IsReceivedByReceiver).HasColumnName("isReceivedByReceiver");
            entity.Property(e => e.ParcelCode).HasColumnName("parcelCode");
            entity.Property(e => e.ParcelTypeId).HasColumnName("parcelTypeId");
            entity.Property(e => e.Price)
                .HasColumnType("decimal(18, 2)")
                .HasColumnName("price");
